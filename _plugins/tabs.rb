# From https://github.com/Ovski4/jekyll-tabs
...
def sanitizeName(name)
    return name
        ...
        .gsub(/^-|-$/, '')      # replace leading or trailing dashes
end
    ...
    module Tabs
        class TabsBlock < Liquid::Block
            ...
            def render(context)
                ...
                templateFile = File.read(currentDirectory + '/tabs-template.erb')
        ...
        class TabBlock < Liquid::Block
            ...
            def initialize(block_name, markup, tokens)
                ...
                @tab = markups[1]
                raise SyntaxError.new("Tab #{@name} requires a title. Format: {% tab <tab_group> <tab_name> %}") if @tab == ''
            end
            ...
            def render(context)
                ...
                environment["tabs-#{@name}"][converter.convert(@tab)] = converter.convert(render_block(context))
            end
        end
    end
end
